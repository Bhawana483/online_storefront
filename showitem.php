...
END_OF_BLOCK;
 ...
 <select id="$sel_item_color" name="$sel_item_color">';
	...
	if (mysqli_num_rows($get_sizes_res) > 0) {
		$display_block .= '<p><label for="$sel_item_size">Available Sizes:</label><br/><select id="$sel_item_size" name="$sel_item_size">';
	...
	$display_block .= '<p><label for="$sel_item_qty">Select Quantity:</label><select id="$sel_item_qty" name="$sel_item_qty">';
